...
export function DashboardPage() {
  ...
  return (
    <div className="space-y-7">
      <div>
        <p className="mb-1 text-xs font-bold uppercase tracking-[0.16em] text-primary">Ringkasan operasi</p>
        <h1 className="text-2xl font-bold tracking-tight">Papan Pemuka</h1>
        <p className="mt-1 text-sm text-muted-foreground">Ringkasan pinjaman peralatan ICT hari ini.</p>
      </div>
